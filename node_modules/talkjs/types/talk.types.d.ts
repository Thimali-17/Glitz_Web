...
export declare interface ConversationRef {
     ...
     *
     * Does not support {@link https://talkjs.com/docs/Reference/JavaScript_Chat_SDK/Realtime_API/#automatic-batching | Automatic Batching} yet. Sequential calls will be sent as multiple requests.
     *
...
export declare interface ParticipantRef {
     ...
     * You must be a participant in the conversation to fetch information about other participants.
     *
     * @returns A snapshot of the participant's attributes, or null if the user is not a participant.
     */
     ...
     *
     * @remarks
     * If the user is already not a participant this operation is still considered successful and the promise will still resolve.
     * This operation fails if client-side conversation syncing is disabled.
     *
     * @returns A promise that resolves when the operation completes.
     */
...
export declare interface UserRef {
     ...
     *
     * @remarks
     * `name` is required when creating a user. This operation fails if you don't provide a `name` and the user does not exist yet.
     * This operation also fails if client-side user syncing is disabled.
     *
     * @returns A promise that resolves when the operation completes.
     */
     ...
     * This operation fails if client-side user syncing is disabled.
     *
     * @returns A promise that resolves when the operation completes.
     */
...
export declare interface UserSubscription {
     ...
     *
     * `latestSnapshot` is only set when `type` is "active". It contains the most recently received snapshot for this subscription.
     *
     * `error` is only set when `type` is "error". It is the JS `Error` object for the error that caused the subscription to be terminated.
     */
